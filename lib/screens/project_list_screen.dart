...
class _ProjectListScreenState extends State<ProjectListScreen> {
              ...
              child: FutureBuilder<List<ProjectListItem>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return const Center(
                        child: Text('프로젝트가 없습니다. + 버튼을 눌러 추가하세요.'));
                  }
                  ...
                  if (isMobile) {
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          _buildProjectItem(projects[index]),
                    );
                  }
  ...
  Widget _buildProjectItem(ProjectListItem project) {
    return Dismissible(
      ...
      confirmDismiss: (_) async {
        return await showDialog<bool>(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: Text('"${project.name}" 프로젝트를 삭제하시겠습니까?\n이 작업은 되돌릴 수 없습니다.'),
            actions: [
              TextButton(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  project.description.isEmpty ? '설명 없음' : project.description,
                  maxLines: 2,
                  overflow: TextOverflow.ellipsis,
                ),
